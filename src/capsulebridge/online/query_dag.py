...
def build_query_dag(question: str, llm, config: CapsuleBridgeConfig) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        logger.warning(f"[CapsuleBridgeRAG] [ONLINE_QDAG] fallback to single-node DAG | err={type(e).__name__}: {e}")
        return _single_node_dag(question)
